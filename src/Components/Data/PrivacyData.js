export const privacyData = [
  {
    id: 1,
    title: 'Air Filters Factory Privacy Policy',
    description1:
      'This Privacy Policy governs the way airfiltersfactory.com collects, uses, maintains and discloses information collected from users (each, a “User”) of the airfiltersfactory.com website (“Site”). This privacy policy applies to the site and all products and services offered by airfiltersfactory.com.',
  },
  {
    id: 2,
...
export const privacyData1 = [
  {
    id: 1,
    title: 'General Terms and Conditions applicable to Use of a Website',
    description: [
      {
        id: 1,
        description:
      ...
      },
      {
        id: 17,
        description:
          'Airfiltersfactory.com may collect and use Users personal information for the following purposes; To improve customer service: Information you provide helps us respond to your customer service requests and support needs more efficiently.',
      },
      {
        id: 18,
        description:
